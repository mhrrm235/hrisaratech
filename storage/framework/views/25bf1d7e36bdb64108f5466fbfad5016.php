...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('mazer/assets/extensions/simple-datatables/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('mazer/assets/compiled/css/table-datatable.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('mazer/assets/extensions/@icon/dripicons/dripicons.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('mazer/assets/compiled/css/ui-icons-dripicons.css')); ?>">
...
<body>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <?php if(session('role')  == 'Power User' || session('role')  == 'HR'): ?>
                        ...
                        <?php if(session('role')  == 'Power User' || session('role')  == 'Developer'): ?>
                        <li class="sidebar-item">
                            <a href="<?php echo e(url('/presences')); ?>" class='sidebar-link'>
                                <i class="bi bi-table"></i>
                                <span>Presences</span>
    ...
    <script src="<?php echo e(asset('mazer/assets/extensions/simple-datatables/umd/simple-datatables.js')); ?>"></script>
    <script src="<?php echo e(asset('mazer/assets/static/js/pages/simple-datatables.js')); ?>"></script>
    <script src="<?php echo e(asset('mazer/assets/extensions/chart.js/chart.umd.js')); ?>"></script>
    <script src="<?php echo e(asset('mazer/assets/static/js/pages/ui-chartjs.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\hr-app\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>