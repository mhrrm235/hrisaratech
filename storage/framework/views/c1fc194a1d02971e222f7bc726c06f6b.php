                                            ...
                                            <td class="col-3">
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md">
                                                        <?php $emp = $task->employee; ?>
                                                        <img src="https://ui-avatars.com/api/?name=<?php echo e($emp?->fullname ?? 'Unknown'); ?>&background=random">
                                                    </div>
                                                    <p class="font-bold ms-3 mb-0"><?php echo e($emp?->fullname ?? 'Unknown Employee'); ?></p>
                                                </div>
                                            </td>
                                            <td class="col-auto">
                                                <p class=" mb-0"><?php echo e($task->title); ?></p>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr-app\resources\views/dashboard/index.blade.php ENDPATH**/ ?>